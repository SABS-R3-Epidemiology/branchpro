...
class TestNegBinBranchProModelClass(unittest.TestCase):
    ...
    def test__init__(self):
        with self.assertRaises(ValueError):
            bp.NegBinBranchProModel(0, [0], 5)

        with self.assertRaises(TypeError):
            bp.NegBinBranchProModel('0', [1], 5)
    ...
    def test_get_serial_intervals(self):
        nbbr_model = bp.NegBinBranchProModel(0, [1, 2], 5)
        npt.assert_array_equal(
            nbbr_model.get_serial_intervals(), np.array([1, 2]))

    def test_get_r_profile(self):
        nbbr_model1 = bp.NegBinBranchProModel(0, [1, 2], 5)
    ...
    def test_set_r_profile(self):
        ...
        nbbr_model2 = bp.NegBinBranchProModel(0, [1, 2], 5)
    ...
    def test_get_overdispersion(self):
        nbbr_model = bp.NegBinBranchProModel(0, [1, 2], 5)
        self.assertEqual(nbbr_model.get_overdispersion(), 5)
...
class TestLocImpNegBinBranchProModelClass(unittest.TestCase):
    ...
    def test__init__(self):
        with self.assertRaises(TypeError):
            bp.LocImpNegBinBranchProModel(0, [1], '0', 5)

        with self.assertRaises(ValueError):
            bp.LocImpNegBinBranchProModel(0, [1], -13, 5)
    ...
    def test_get_overdispersion(self):
        linbbr_model = bp.LocImpNegBinBranchProModel(0, [1, 2], 0, 5)
        self.assertEqual(linbbr_model.get_overdispersion(), 5)
    ...
    def test_simulate(self):
        ...
        simulated_sample_model_2 = linbbr_model_2.simulate(1, [2, 4, 7])
        self.assertEqual(simulated_sample_model_2.shape, (3,))

        linbbr_model_3 = bp.LocImpNegBinBranchProModel(0, [1, 2], 0, 5)
        linbbr_model_3.set_r_profile([3, 1], [1, 2], 3)
        linbbr_model_3.set_imported_cases([1, 2, 4, 8], [5, 10, 9, 2])
        simulated_sample_model_3 = linbbr_model_3.simulate(1, [2, 4, 7])
        self.assertEqual(simulated_sample_model_3.shape, (3,))
