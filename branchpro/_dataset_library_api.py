...
class DatasetLibrary(object):
    ...
    def french_flu(self):
        ...
        `time_index`
            index of the time point represented in the data file;
        `year`
            year of that particular incidence value;
        `week`
            week of that particular incidence value;
        `day`
            day of that particular incidence value;
        `inc`
            number of flu cases at that time point;
        `inc_low`
            lower bound of the 95% confidence interval of the number
            of flu cases at that time point;
        `inc_up`
            upper bound of the 95% confidence interval of the number
            of flu cases at that time point;
        `inc100`
            number of flu cases at that time point reported to
            100,000 people;
        `inc100_low`
            lower bound of the 95% confidence interval of the number
